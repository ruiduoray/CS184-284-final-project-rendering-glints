...
class BSDF {
 public:
   ...
   */
  virtual Vector3D f (const Vector3D wo, const Vector3D wi, Vector3D hit_p) = 0;
...
class DiffuseBSDF : public BSDF {
 public:
   ...
   */
  DiffuseBSDF(texture *a) : reflectance(a) { }

  Vector3D f(const Vector3D wo, const Vector3D wi, Vector3D hit_p);
